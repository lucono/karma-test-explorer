...
export class TestSuiteOrganizer {
	...
	public organizeTests(
		...
		options: TestSuiteOrganizationOptions = defaultTestSuiteOrganizerOptions
	): TestSuiteInfo {
	...
	public adjustTopLevelSuiteToTestsBasePath(
		...
		topLevelFolderSuite.label = topLevelSuiteIsUnderTestsBasePath
			? relative(testsBasePath, topLevelSuiteAbsolutePath)
			: testsBasePathIsUnderTopLevelSuite || topLevelSuiteIsSameAsTestsBasePath
			? basename(topLevelFolderSuite.label)
