...
export const getDefaultAngularProjectConfig = (workspaceRootPath: string, configDefaultProject?: string): AngularProject => {
  const angularProjects = getAllAngularProjectsConfig(workspaceRootPath);
...
const getAllAngularProjectsConfig = (workspaceRootPath: string): AngularProject[] => {
