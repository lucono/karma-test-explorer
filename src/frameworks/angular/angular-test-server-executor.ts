...
import { KARMA_PORT_ENV_VAR, KARMA_SOCKET_PORT_ENV_VAR, USER_KARMA_CONFIG_PATH_ENV_VAR } from "../karma/karma-constants";
...
export class AngularTestServerExecutor implements TestServerExecutor {
    ...
    karmaSocketPort: number): Execution<ServerStopExecutor>
  {
    const env: { [key: string]: string } = {
      ...
      [USER_KARMA_CONFIG_PATH_ENV_VAR]: this.angularProject.karmaConfigPath,
