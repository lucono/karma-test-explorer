...
The `Karma Test Explorer` extension provides visual running and debugging of Karma tests in Visual Studio Code with the
[Test Explorer UI](https://marketplace.visualstudio.com/items?itemName=hbenl.vscode-test-explorer) extension.

It is a significant rewrite based on the [Angular/Karma Test Explorer](https://github.com/Raagh/angular-karma_test-explorer) extension and focuses on providing more robust support for Karma tests (and does so without any special accommodations for Angular).
