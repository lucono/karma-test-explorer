...
`karmaTestExplorer.enabledParserPlugins` | Experimental and subject to change in future releases! Specifies the parser plugins to enable for parsing test files
